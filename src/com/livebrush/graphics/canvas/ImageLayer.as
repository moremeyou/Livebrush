package com.livebrush.graphics.canvas
{
	...
	public class ImageLayer extends Layer implements Storable
	{
		
		public var src											:String;
		public var assetCenter									:Object;
		
		public function ImageLayer (canvas:Canvas, depth:int=0):void
		{
			super(canvas, depth);
			_type = Layer.IMAGE;
			init();
		...
		{
			var newLayer:ImageLayer = new ImageLayer(canvas);
